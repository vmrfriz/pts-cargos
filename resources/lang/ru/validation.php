...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'available'             => 'Доступно',
        'size'                  => 'Размер',
        'load_points'           => 'Адреса погрузки',
        'unload_points'         => 'Адреса выгрузки',
        'price'                 => 'Бюджет',
        'loading_time'          => 'Время погрузки',
        'loading_comment'       => 'Комментарий к погрузке',
        'unloading_time'        => 'Время выгрузки',
        'unloading_comment'     => 'Комментарий к выгрузке',
